...
//   return (
//     <div className="container mt-4">
//       <h2 className="text-center mb-4">Doctor Appointment Booking</h2>
...
//       {showToast && (
//         <div className="alert alert-success alert-dismissible fade show position-fixed w-50 top-0 start-50 translate-middle-x mt-3 shadow" role="alert" style={{ zIndex: 1050 }}>
