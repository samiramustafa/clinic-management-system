...
//                 password: "Password must be at least 8 characters long, contain an uppercase letter, a lowercase letter, and a number",
//                 phoneNumber: "Phone number should be 11 digits",
//                 username: "Username should be 5 to 20 characters long",
//                 nationalId: "National ID should be 14 digits"
//             };
...
//                     <div className="mb-3">
//                         <label className="form-label">Role</label>
//                         <select className="form-select" name="role" value={formData.role} required onChange={handleChange}>
//                             <option value="patient">Patient</option>
//                             <option value="doctor">Doctor</option>
//                         </select>
//                     </div>
...
//                     <hr className="flex-grow-1" />
//                 </div>
//                 <Link to="/login" className="btn btn-light w-100 border fw-bold fs-5 text-dark text-decoration-none">Login</Link>
//             </div>
//         </div>
//     );
// };
